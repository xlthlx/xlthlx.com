...
function xlthlx_scripts() {
	...
	wp_enqueue_style( 'google-fonts', esc_url('https://fonts.googleapis.com/css2?family=JetBrains+Mono&family=Shadows+Into+Light&family=Titillium+Web&display=swap'), array(), '1.0' );
	// Scripts.
