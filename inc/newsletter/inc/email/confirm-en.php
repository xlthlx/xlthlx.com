														...
														<table width="100%" cellpadding="0" cellspacing="0" border="0"
															...
															<tr>
																<td style="border-collapse:collapse;text-align:center">
																  ...
																  <![endif]--><a href="https://xlthlx.com/newsletter/en/?act=confirm&cod=<?php echo $code; ?>" style="color:#ffffff;text-decoration:none !important;display:inline-block;-webkit-text-size-adjust:none;mso-hide:all;text-align:center;background-color:#6667ab;border-color:#000000;border-width:0px;border-radius:0px;border-style:solid;width:288px;line-height:36px;font-size:16px;font-weight:normal">
																		CONFIRM EMAIL</a>
																</td>
															</tr>
															</tbody>
