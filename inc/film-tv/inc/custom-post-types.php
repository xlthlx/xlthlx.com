...
function xlt_film_init() {
	...
	$film = 'data:image/svg+xml;base64,' . base64_encode( '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
	<path fill="#FFFFFF"
...
function xlt_tv_series_init() {
	...
	$tv = 'data:image/svg+xml;base64,' . base64_encode( '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
	<path fill="#FFFFFF"
