...
<footer class="xlt-f">
	...
	<div class="xlt-row xlt-row_break">
		...
		<div class="xlt-copy">
			<p>
				<a title="Back to top" class="xlt-arrow-up" href="#top">
					&uarr;
				</a>
			</p>
		</div>
