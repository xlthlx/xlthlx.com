			...
			<ul>
				...
				<li>
					<a class="xlt-shrink" href="<?php echo $site_url; ?>mode/" title="Dark mode" id="btn-toggle">
						...
						<svg fill="var(--theme-text-color)" width="32" height="26" aria-label="Dark mode" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
				...
				<li>
					<a class="xlt-shrink" title="Feed RSS" target="_blank" href="<?php echo $site_url; ?>feed/">
						...
						<svg width="32" height="26" aria-label="Feed RSS" role="img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><path d="M4 11C6.38695 11 8.67613 11.9482 10.364 13.636C12.0518 15.3239 13 17.6131 13 20M4 4C8.24346 4 12.3131 5.68571 15.3137 8.68629C18.3143 11.6869 20 15.7565 20 20M6 19C6 19.5523 5.55228 20 5 20C4.44772 20 4 19.5523 4 19C4 18.4477 4.44772 18 5 18C5.55228 18 6 18.4477 6 19Z" stroke="var(--theme-text-color)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
					</a>
				</li>
			</ul>
		</div>
								...
								<li class="<?php echo $menu_item['classes']; ?>">
									...
									<ul class="sub-menu">
										<?php foreach ( $menu_item['submenu'] as $menu_subitem ) { ?>
											<li <?php echo $menu_subitem['target']; ?>
													class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9097">
												<a title="<?php echo $menu_subitem['title']; ?>"
