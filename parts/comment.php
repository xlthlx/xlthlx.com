	...
	<article id="div-comment-<?php echo $args['comment']->comment_ID; ?>" class="comment-body">
		<footer class="comment-meta">
			<div class="comment-author vcard">
				<?php echo xlt_get_avatar( $args['comment'], $args['comment']->comment_author ); ?> <b
						class="fn"><?php echo xlt_get_author( $args['comment'] ); ?></b></div>

			<div class="comment-metadata">
				<a href="<?php echo esc_url( get_comment_link( $args['comment'] ) ); ?>">
					<time datetime="<?php echo xlt_atom_date( $args['comment']->comment_date ); ?>"><?php echo xlt_get_comment_date( $args['comment']->comment_date ); ?></time>
				</a>
